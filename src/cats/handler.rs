...
use cats::Cat;
use mongodb::{bson::doc, error::ErrorKind, bson::oid::ObjectId};
use rocket::http::Status;
use rocket_contrib::json::Json;

fn error_status(error: r2d2_mongodb::mongodb::Error) -> Status {
    match error {
...
//             Err(err) => Err(error_status(err)),
//         },
//         Err(_) => Err(error_status(
//             ErrorKind::InternalError{
//                 message: String::from("Couldn't parse ObjectId",)
//             }
//         )),
//     }
// }
